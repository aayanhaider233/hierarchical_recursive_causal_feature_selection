...
All raw datasets are publicly available from GEO and can be downloaded using the accession numbers listed above.
...
The raw GEO files are not redistributed in this repository because they are publicly hosted by NCBI GEO.
